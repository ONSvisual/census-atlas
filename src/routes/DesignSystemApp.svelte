...
<ONSCensusApp>
  ...
  <ONSExternalHeaderWithDescription serviceTitle="Explore Census" description="Here's a place where we tell users what the Census Atlas is and what it can do for them."/>
</DesignSystemPanel>
