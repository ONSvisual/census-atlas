...
<BasePage {serviceTitle} {description}>
  <DesignSystemPanel title="Default header" code={`<DefaultHeader serviceTitle="Explore Census" description="Here's a place where we tell users what the Census Atlas is and what it can do for them."/>`}>
    <DefaultHeader serviceTitle="Explore Census" description="Here's a place where we tell users what the Census Atlas is and what it can do for them."/>
  </DesignSystemPanel>
